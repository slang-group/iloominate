( function ( $ ) {
	...
	/*
		...
		*/
		'ar-kbd': {
			name: 'أرابيك',
			source: '/jqime/rules/ar/ar-kbd.js'
		},
		/*
		'as-avro': {
			name: 'অভ্ৰ',
		...
		'ne-inscript': {
			name: 'इनस्क्रिप्ट',
			source: '/jqime/rules/ne/ne-inscript.js'
		},
		'ne-inscript2': {
			name: 'इनस्क्रिप्ट २',
			source: '/jqime/rules/ne/ne-inscript2.js'
		},
		'ne-transliteration': {
			name: 'ट्रांस्लितेरेशन',
			source: '/jqime/rules/ne/ne-transliteration.js'
		},
		'ne-rom': {
			name: 'Romanized',
			source: '/jqime/rules/ne/ne-rom.js'
		},
		'ne-trad': {
			name: 'Traditional',
			source: '/jqime/rules/ne/ne-trad.js'
		},
		/*
		'nb-normforms': {
		...
		*/
		'ipa-sil': {
			...
			source: '/jqime/rules/fonipa/ipa-sil.js'
		},
		'ipa-x-sampa': {
			name: 'International Phonetic Alphabet - X-SAMPA',
			source: '/jqime/rules/fonipa/ipa-x-sampa.js'
		},
		/*
		'udm-alt': {
			name: 'Удмурт ALT',
